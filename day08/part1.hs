...
main = do
    ...
    let result = processLocations 1000 locations
    print result
...
smallestNDistances :: Int -> [LocationInfo] -> [LocationInfo]
smallestNDistances n = take n . sortOn distanceBetween

makeCircuits :: [LocationInfo] -> [Set Location]
makeCircuits = makeCircuitsAux []

makeCircuitsAux :: [Set Location] -> [LocationInfo] -> [Set Location]
makeCircuitsAux circuits [] = circuits
makeCircuitsAux circuits (l : ls) = makeCircuitsAux totalCircuits ls
    where
        circuitsConnected =
...
processLocations :: Int -> [Location] -> Int
processLocations numberOfDistances = product
    . map size
    . take 3
    . sortOn (negate . size)
    . makeCircuits
    . smallestNDistances numberOfDistances
    . allDistances
